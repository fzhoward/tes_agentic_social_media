...
| E3 | **CTA names the action specifically.** "Contact us" is too vague. Must name the specific action (call, DM, visit, comment, etc.) with the destination. Bad example: "Feel free to reach out" Good example: "Drop a comments and tell us" | Soft fail | CTA Skill: General Rules |
