...
def build_drafter_messages(
    ...
    system_message = (
        ...
        "5. For GBP captions, never write a phone number or street address in "
        "the body. Google rejects GBP posts that put contact info in the post "
        "text (phone-stuffing policy). The CALL button carries the phone "
        "(verified listing number); the listing carries the address. Express "
        "call CTAs verbally without digits (for example \"Call for "
        "availability\"), never by typing the number.\n\n"
